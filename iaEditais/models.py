...
class TestCollection:
    ...
    created_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_collections_created_by'),
        nullable=True,
        default=None,
    )
    updated_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_collections_updated_by'),
        nullable=True,
        default=None,
    )
    deleted_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_collections_deleted_by'),
        nullable=True,
        default=None,
    )
...
class AIModel:
    ...
    created_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_ai_models_created_by'),
        nullable=True,
        default=None,
    )
    updated_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_ai_models_updated_by'),
        nullable=True,
        default=None,
    )
    deleted_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_ai_models_deleted_by'),
        nullable=True,
        default=None,
    )
...
class Metric:
    ...
    name: Mapped[str] = mapped_column(nullable=False)
    # model_id removed as requested (dynamic at runtime)
    ...
    created_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_metrics_created_by'),
        nullable=True,
        default=None,
    )
    updated_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_metrics_updated_by'),
        nullable=True,
        default=None,
    )
    deleted_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_metrics_deleted_by'),
        nullable=True,
        default=None,
    )
...
class TestCase:
    ...
    test_collection_id: Mapped[UUID] = mapped_column(
        ForeignKey('test_collections.id', name='fk_test_cases_test_collection_id'),
        nullable=False,
    )
    name: Mapped[str] = mapped_column(nullable=False)
    ...
    created_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_cases_created_by'),
        nullable=True,
        default=None,
    )
    updated_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_cases_updated_by'),
        nullable=True,
        default=None,
    )
    deleted_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_cases_deleted_by'),
        nullable=True,
        default=None,
    )
...
class TestRun:
    ...
    test_collection_id: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('test_collections.id', name='fk_test_runs_test_collection_id'),
        nullable=True,
    )
    ...
    created_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_runs_created_by'),
        nullable=True,
        default=None,
    )
    updated_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_runs_updated_by'),
        nullable=True,
        default=None,
    )
    deleted_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_runs_deleted_by'),
        nullable=True,
        default=None,
    )
...
class TestResult:
    ...
    created_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_results_created_by'),
        nullable=True,
        default=None,
    )
    updated_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_results_updated_by'),
        nullable=True,
        default=None,
    )
    deleted_by: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey('users.id', name='fk_test_results_deleted_by'),
        nullable=True,
        default=None,
    )
